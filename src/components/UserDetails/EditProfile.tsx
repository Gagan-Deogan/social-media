...
export const EditProfile = ({
  ...
  const [
    { newFullname, newBio, newProfileImage, newHeaderImage },
    dispatch,
  ...
  const handleSubmit = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    if (fullname && bio) {
      appDispatch(updateProfile({ newFullname, newBio }));
    }
  };

  return (
    <div className="bg-white sm-w10 md-w6 w5 bor-rad-12 padding-16">
